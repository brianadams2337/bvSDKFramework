...
function loadReviewCommentsWidget (content, options) {
	...
	if (commentsToDisplay.length > 0) {
		...
		$($template).find(reviewCommentsContainers["toggleContainer"]).andSelf().addClass("BVReviewCommentsHasComments").filter(reviewCommentsContainers["toggleContainer"]).attr({
